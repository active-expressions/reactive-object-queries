define([
	...
	var MapBuilder = {
        ...
        createExamples: function(layer, world) {
            ...
            if(window.doEntityFinder) {
				this.createEntityFinder(layer, world);
			}
            if(window.doOutOfScreenRendering) {
        ...
        createOutOfScreenIndicators: function(layer, world) {
            ...
            select(Entity, function(entity) {
                ...
                debugDraw: function(renderer) {
                    ...
                    var dotOnBorder = findBorderDotFor(this.body.getPosition());
					renderer.drawCircle(dotOnBorder, 1, 'white', 1.0, 2, true, 'orange');
                }
            });
        },
		// Enhance given world with several bodies, etc. for testing purpose.
