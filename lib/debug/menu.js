...
domReady(function() {
	...
	/*
	var stats = new Stats();
	jQuery(stats.domElement)
		.css("position", "absolute")
		.css("top", jQuery(window).scrollTop() + "px")
		.prependTo(jQuery("body"));
	jQuery(window).scroll(function() {
	    jQuery(stats.domElement).css('top', jQuery(this).scrollTop() + "px");
	});
	*/
	...
	*/
	...
	Bloob.Debug = mini.Class.subclass({
		...
		initialize: function() {
			...
			this.numberContainer = jQuery('<div />');
