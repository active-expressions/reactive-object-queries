define(function(require) {
	...
	AABB.prototype.set = function(aabb) {
		...
		this.Validity = aabb.Validity;
	};

	AABB.prototype.scaleVector = function(extentModifier) {
		var middlePoint = this.getMiddle(),
			extent = this.Max.sub(middlePoint).mulVector(extentModifier);

		return new AABB(
			middlePoint.add(extent),
			middlePoint.sub(extent)
		);
	};
