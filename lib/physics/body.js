define(function(require) {
	...
	Body.prototype.getPosition = function() { return this._derivedPosition; };
	...
	Body.prototype.debugDraw = function(debugDraw) {
		...
		var shouldDrawAABB = document.querySelector('#showBoundingBoxes');
		if(shouldDrawAABB && shouldDrawAABB.checked) {
	...
	Body.prototype.debugDrawPolygon = function(debugDraw) {
		...
		debugDraw.drawPolyline(positions, "black", 1.0, 1.5);
	};
